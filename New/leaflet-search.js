...
L.Control.Search = L.Control.extend({
	...
	options: {
		...
		propertyLoc: 'geometry',				//field for remapping location, using array: ['latname','lonname'] for select double fields(ex. ['lat','lon'] ) support dotted format: 'prop.subprop.title'
		...
		textErr: 'County not found',	//error message
		textCancel: 'X',		    //title in cancel button		
		textPlaceholder: 'Search county...',   //placeholder value			
